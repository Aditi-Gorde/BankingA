...
<body>
    ...
    <nav class="navbar navbar-inverse" style="padding-top: 2px;">
        ...
        <li class="active"><a href="ULoan.php" style="color:#dfd3c3;">Loan Appliers</a></li>
            </ul>
      ...
      <div class="container">
            <table class="table">
              ...
              //  $conn=mysqli_connect("sql6.freemysqlhosting.net","sql6417933","N2sBfMWEYg","sql6417933");
                ...
                $sql="Select Id, Name, Email, Loan_amount, Interest from Users, Loan where Loan.id=Users.Branch_ID";
                ...
                if($result->num_rows>0){
                    while($row=$result->fetch_assoc()){
                        ...
                        <td style="color: #dfd3c3;"><?php echo $row['Loan_amount']?></td>
                        <td style="color: #dfd3c3;"><?php echo $row['Interest']?></td>
                    </tr>
